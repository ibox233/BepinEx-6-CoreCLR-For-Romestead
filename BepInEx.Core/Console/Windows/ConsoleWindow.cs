...
internal class ConsoleWindow
{
    ...
    private static void Initialize()
    {
        ...
        setForeground = Marshal.GetDelegateForFunctionPointer<SetForegroundWindowDelegate>(
            GetProcAddress(user32Dll, "SetForegroundWindow"));
        getForeground = Marshal.GetDelegateForFunctionPointer<GetForegroundWindowDelegate>(
            GetProcAddress(user32Dll, "GetForegroundWindow"));
        getSystemMenu = Marshal.GetDelegateForFunctionPointer<GetSystemMenuDelegate>(
            GetProcAddress(user32Dll, "GetSystemMenu"));
        deleteMenu = Marshal.GetDelegateForFunctionPointer<DeleteMenuDelegate>(
            GetProcAddress(user32Dll, "DeleteMenu"));
    }
