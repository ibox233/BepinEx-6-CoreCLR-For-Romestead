...
internal static class PlatformUtils
{
    ...
    public static void SetPlatform()
    {
        ...
        {
            var utsname = new utsname_linux();
            if (uname_linux(ref utsname) == IntPtr.Zero)
            {
                LinuxArchitecture = utsname.machine;
                LinuxKernelVersion = utsname.version;
            }
        }
    }
    ...
    public static bool IsWine => !string.IsNullOrEmpty(WineVersion);
